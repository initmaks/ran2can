...
-- FLAGS etc.
RECORD_CAMERA = true
data_folder = '/home/dl/data/vrep/v2/'
...
function episode()
    ...
    if captures_made % captures_per_drop == 0 or elapsed_time > 2.0 then -- every N image captures OR M seconds
        -- restart the episode
        episode_start_time = sim.getSimulationTime() 
        move_table()
